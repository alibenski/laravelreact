                ...
                <Card className="mb-4">
                    <CardContent>
                        <div align="justify">
                            ...
                            <Typography paragraph={true}>
                                While the submitted project and contact information will only be available to logged-in users, it is recommended that only a basic description of any project is provided through the <i>conecta</i> platform. All private, sensitive or confidential information should be omitted at this point and only shared with volunteers directly and outside of this platform, in accordance with <a href="https://undocs.org/ST/SGB/2007/6">ST/SGB/2007/6</a> – Information sensitivity, classification and handling.
                        </Typography>
                            <Typography paragraph={true}>
                            ...
                            <Typography paragraph={true}>
                                Volunteering is strictly voluntary in nature and doesn’t lead or give rise to an entitlement or expectation of any contractual benefit or remuneration for the help provided. Equally, the help received should not be used or misused and should not replace the need for a full-fledged position, should the nature of the project/need require such a level of engagement.
                        </Typography>
                            <Typography paragraph={true}>
